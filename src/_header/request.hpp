...
# define SERVER_PREFIX	std::string("outstanding.127.0.0.1")
...
# define LOG_PART(fd, nick, channel)("[" + fd + "] <" + nick + "> PART <" + channel + ">")
# define LOG_RMCHANNEL(channel)("<" + channel + "> is destroy")
...
# define ERR_UNKNOWNCOMMAND(client, command)(":" + SERVER_PREFIX + " 421 " + client + " "  + command + " :command is unknown to the server")
...
# define ERR_ERRONEUSNICKNAME(client, nickname)(":" + SERVER_PREFIX + " 432 " + client + " " + nickname + " :Erroneus nickname")
# define ERR_NICKNAMEINUSE(client, nick)(":" + SERVER_PREFIX + " 433 " + client + " " + nick + " :Nickname is already in use")
# define ERR_NICKNAMEINUSEC(nick)(":" + SERVER_PREFIX + " 433 * " + nick + " :Nickname is already in use")
# define ERR_ERRONEUSUSERNAME(client, username)(":" + SERVER_PREFIX + " 432 " + client + " " + username + " :Erroneus username")
# define ERR_USERNAMEINUSE(client, username)(":127.0.0.1 433 * " + client + " " + username + " :Username is already in use")
# define ERR_NORECIPIENT(client, command)(":" + SERVER_PREFIX + " 411 " + client + " " + command + " :No recipient given")

# define ERR_USERNOTINCHANNEL(nick, channel)(":" + SERVER_PREFIX + " 441 " + nick + " #" + channel + " :They aren't on that channel")
# define ERR_NOTONCHANNEL(client, channel)(":" + SERVER_PREFIX + " 442 " + client + " #" + channel + " :Not on that channel")
# define ERR_NOTREGISTERED()(":" + SERVER_PREFIX + " 451 :You have not registered")
# define ERR_NEEDMOREPARAMS(client, cmd)(":" + SERVER_PREFIX + " 461 " + client + " " + cmd + " :Not enough parameters")
# define ERR_ALREADYREGISTRED(client)(":" + SERVER_PREFIX + " 462 " + client + " :You may not reregister")
# define ERR_PASSWDMISMATCH(client)(":" + SERVER_PREFIX + " 464 " + client + " :Password incorrect")
# define ERR_KEYSET(nick, channel)(":" + SERVER_PREFIX + " 467 " + nick + " #" + channel + " :Channel key already set")
# define ERR_CHANNELISFULL(client, channel)(":" + SERVER_PREFIX + " 471 " + client + " #" + channel + " :Cannot join channel (+l)")
# define ERR_UNKNOWNMODE(client, mode)(":" + SERVER_PREFIX + " 472 " + client + " " + mode + " :is unknown mode char to me")
# define ERR_INVITEONLYCHAN(client, channel)(":" + SERVER_PREFIX + " 473 " + client + " #" + channel + " :Cannot join channel (+i)")
# define ERR_BADCHANNELKEY(client, channel)(":" + SERVER_PREFIX + " 475 " + client + " #" + channel + " :Cannot join channel (+k)")
# define ERR_NOCHANMODES(channel)(":" + SERVER_PREFIX + " 477 #" + channel + " :Channel doesn't support modes")
...
# define RPL_KICK(prefix, channel, target, comment)(prefix + " KICK #" + channel + " " + target + " :" + comment)
# define RPL_INVITERCVR(prefix, invitee, channel)(prefix + " INVITE " + invitee + " #" + channel)
# define RPL_NICK(newNick)(":" + SERVER_PREFIX + " NICK " + newNick)
...
# define  RPL_PRIVMSGCHANNEL(prefix, channel, msg)(prefix + " PRIVMSG #" + channel + " :" + msg)
# define  RPL_PRIVMSGUSER(prefix, user, msg)(prefix + " PRIVMSG " + user + " :" + msg)
