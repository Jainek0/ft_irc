...
# define RPL_INVITERCVR(prefix, invitee, channel)(std::string(prefix)  + " INVITE " + invitee + " #" + channel)
# define RPL_NICK(prefix, newNick)(std::string(prefix) + " NICK " + newNick)
# define RPL_TOPIC(prefix, channel, topic)(std::string(prefix)  + " TOPIC #" + channel + " :" + topic)
